...
struct NetflixDetailsProductView: View {
    ...
    var isTopTen: Int? = 6
    var descriptionText: String? = "Lorem Ipsum is simply dummy text of the printing and typesetting industry."
    var castText: String? = "Cast: Benji, Your Name, Someone else"
